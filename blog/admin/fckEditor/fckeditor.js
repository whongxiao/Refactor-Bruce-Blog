...
FCKeditor.prototype._GetIFrameHtml = function()
{
	...
	return '<iframe id="' + this.InstanceName + '___Frame" src="' + sLink + '" width="' + this.Width + '" height="' + this.Height + '" frameborder="0" scrolling="no"><input id="ddddd" type="hidden"></iframe>' ;
}
